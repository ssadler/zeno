...
notarise="stack exec --profile zeno -- notarise"
...
tmux send-keys -t 2 "$notarise $ethkmd --pubkey=$pk0 --port=40441 $RTS -pozeno1" Enter
tmux send-keys -t 3 "$notarise $ethkmd --pubkey=$pk1 --port=40442 $RTS -pozeno2" Enter
tmux send-keys -t 4 "$notarise $ethkmd --pubkey=$pk2 --port=40443 $RTS -pozeno3" Enter
tmux send-keys -t 5 "$notarise $ethkmd --pubkey=$pk3 --port=40444 $RTS -pozeno4" Enter
